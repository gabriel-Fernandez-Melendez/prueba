...
public class Datos {
	...
	public static Colegiado[] COLEGIADOS = {
			new Colegiado(1, "Junior",  buscarPersonaPorId(1001)),
			new Colegiado(2, "Senior", buscarPersonaPorId(1002)),
			new Colegiado(3, "Junior", buscarPersonaPorId(1003)),
			new Colegiado(4, "Senior", buscarPersonaPorId(1004)),
			new Colegiado(5, "Especial", buscarPersonaPorId(1005)),
			new Colegiado(6, "Junior", buscarPersonaPorId(1006)),
			new Colegiado(7, "Senior", buscarPersonaPorId(1007)),
			new Colegiado(8, "Senior", buscarPersonaPorId(1008)),
			new Colegiado(9, "Junior", buscarPersonaPorId(1009)),
			new Colegiado(10, "Especial", buscarPersonaPorId(1010)),
			new Colegiado(11, "Senior", buscarPersonaPorId(1011)),
			new Colegiado(12, "Senior", buscarPersonaPorId(1012)),
			new Colegiado(13, "Senior", buscarPersonaPorId(1013)),
			new Colegiado(14, "Senior", buscarPersonaPorId(1014)),
			new Colegiado(15, "Especial", buscarPersonaPorId(1015))
	};
